...
yoink the https://github.com/9001/copyparty/tree/hovudstraum/srv/expand

Here's the variable copyparty web UI can interpret into dynamic text stuffs.

Using `{{self.var}}` syntax in a markdown document, that will replace into whatever right hand `var` it ask for.
