...
var tl_cpanel = {
	"ind": {
		"a1": "muat ulang",
		"b1": "apa kabar kawan &nbsp; <small>(anda tidak login)</small>",
		"c1": "logout",
		"d1": "dump stack",  // TLNote: "d2" is the tooltip for this button
		"d2": "shows the state of all active threads",
		"e1": "muat ulang cfg",
		"e2": "muat ulang config files (accounts/volume/volflag),$Nand rescan semua e2ds volumes$N$Nnote: any changes to global settings$Nrequire a full restart to take effect",
		"f1": "Anda dapat melihat:",
		"g1": "Anda dapat unggah ke:",
		"cc1": "hal lainnya:",
		"h1": "nonaktifkan k304",  // TLNote: "j1" explains what k304 is
		"i1": "aktifkan k304",
		"j1": "mengaktifkan k304 akan memutuskan klien Anda setiap kali terjadi HTTP 304, yang dapat menghindari proxy bermasalah dari ngestuck (tiba2 gk bisa memuat halaman), <em>namun</em> biasanya dapat juga memperlambat klien",
		"k1": "atur ulang settingan klien",
		"l1": "login untuk selengkapnya:",
		"m1": "selamat datang kembali,",  // TLNote: "welcome back, USERNAME"
		"n1": "404 tidak ditemukan &nbsp;┐( ´ -`)┌",
		"o1": 'atau mungkin Anda tidak memiliki akses -- cobalah password atau <a href="' + SR + '/?h">kembali ke home</a>',
		"p1": "403 dilarang &nbsp;~┻━┻",
		"q1": 'gunakan password atau <a href="' + SR + '/?h">kembali ke home</a>',
		"r1": "kembali ke home",
		".s1": "scan ulang",
		"t1": "action",  // TLNote: this is the header above the "rescan" buttons
		"u2": "waktu sejak write terakhir server$N( unggah / namai ulang / ... )$N$N17d = 17 hari$N1h23 = 1 jam 23 menit$N4m56 = 4 menit 56 detik",
		"v1": "hubungkan",
		"v2": "use this server as a local HDD",
		"w1": "ganti ke https",
		"x1": "ubah password",
		"y1": "ubah share",  // TLNote: shows the list of folders that the user has decided to share
		"z1": "unlock share ini:",  // TLNote: the password prompt to see a hidden share
		"ta1": "isi password baru Anda terlebih dahulu",
		"ta2": "ulangi untuk mengkonfirmasi password baru:",
		"ta3": "ada typo; mohon coba lagi",
		"aa1": "file yang datang:",
		"ab1": "nonaktifkan no304",
		"ac1": "aktifkan no304",
		"ad1": "mengaktifan no304 akan menonaktifkan semua caching; cobalah ini bila k304 merasa tidak cukup. Ini akan membuang traffic network dalam jumlah sangat buanyak!",
		"ae1": "download yg aktif:",
        "af1": "tunjukan unggahan terakhir",
	},
};
...
var tl_browser = {
	"ind": {
		...
		"cols": {
			...
			"Res": "resolusi",
			"T": "jenis file",
			"aq": "kualitas audio / bitrate",
			"vq": "kualitas video / bitrate",
			"pixfmt": "subsampling / pixel structure",
			"resw": "resolusi horizontal",
			"resh": "resolusi vertical",
			"chs": "kanal audio",
			"hz": "sample rate"
		},
		...
		"goh": "panel-kontrol",
		"gop": 'folder sebelum">prev',
		"gou": 'folder atas">up',
		"gon": 'folder berikut">next',
		"logout": "Logout ",
		"access": " akses",
		...
		"ot_bup": "bup: basic uploader (penunggah dasar), bahkan mendukung netscape 4.0",
		"ot_mkdir": "mkdir: buat direktori baru",
		"ot_md": "new-md: buat sebuah dokumen markdown baru",
		"ot_msg": "msg: kirim pesan ke log server",
		...
		"ot_noie": 'Mohon gunakan Chrome / Firefox / Edge',

		"ab_mkdir": "buat direktori",
		"ab_mkdoc": "markdown doc baru",
		"ab_msg": "kirim psn ke log srv",

		"ay_path": "lompat ke folder",
		"ay_files": "lompat ke file",
		...
		"wt_zip1": "unduh folder ini sebagai arsip",
		"wt_selzip": "unduh pilihan sebagai arsip",
		"wt_seldl": "download selection as separate files$NHotkey: Y",
		"wt_npirc": "salin info track berformat irc",
		"wt_nptxt": "salin info track berformat teks biasa",
		...
		"uct_ok": "sukses", // completed successfully
		...
		"utl_found": "ditemukan",
		"utl_defer": "defer",
		"utl_yolo": "YOLO", // idk "hidup sekali" would be like in Indonesia
		"utl_done": "selesai",
		...
		"ct_utc": 'tunjukan semua tanggal-waktu dalam UTC">UTC',
		"ct_readme": 'munculkan README.md di daftar folder">📜 readme',
		"ct_idxh": 'munculkan index.html bukan daftar folder">htm',
		"ct_sbars": 'munculkan scrollbars">⟊',
		...
		"cft_text": "teks favicon (kosongkan dan refresh untuk menonaktifkan)",
		"cft_fg": "warna foreground",
		"cft_bg": "warna background",
		...
		"mt_c2flac": "kualitas suara terbaik, tapi unduhan sangat besar\">flac",
		"mt_c2wav": "playback tidak terkompresi (lebih besar)\">wav",
		"mt_c2ok": "bagus, pilihan yang baik",
		"mt_c2nd": "format ini tidak direkomendasikan untuk perangkat Anda, tapi okelah",
		"mt_c2ng": "perangkat Anda kelihatannya tidak mendukung format output ini, tapi bisa dicoba sih",
		"mt_xowa": "terdapat bug di iOS yang membuat playback di background menggunakan format ini tidak berfungsi semestinya; mohon gunakan caf atau mp3 saja",
		...
		"mm_eunk": "Galad Tidak Diketahui", // haha Unknown Errol typo
		...
		"gt_ts": "tanggal",
		"gt_ext": "jenis",
		"gt_c1": "singkatkan nama file selebihnya (tunjukan lebih sedikit)",
		"gt_c2": "singkatkan nama file sekurangnya (tunjukan lebih banyak)",
		...
		"s_d1": "min. iso8601",
		"s_d2": "maks. iso8601",
		"s_u1": "diunggah setelah",
		"s_u2": "dan/atau sebelum",
		"s_r1": "path mengandung &nbsp; (dipisah spasi)",
		"s_f1": "nama mengandung &nbsp; (negate dengan -nope)",
		"s_t1": "tags mengandung &nbsp; (^=start, end=$)",
		"s_a1": "properti metadata spesifik",

		"md_eshow": "tidak dapat merender ",
		"md_off": "[📜<em>readme</em>] dinonaktifkan di [⚙️] -- dokumen disembunyikan",

		"badreply": "Gagal ngeparse balasan dari server",

		"xhr403": "403: Akses ditolak\n\ncoba tekan F5, mungkin anda ke-logout",
		"xhr0": "tidak diketahui (kemungkinan besar koneksi ke server hilang, atau servernya offline)",
		"cf_ok": "sorry about that -- DD" + wah + "oS protection kicked in\n\nthings should resume in about 30 sec\n\nif nothing happens, hit F5 to reload the page",
		"tl_xe1": "could not list subfolders:\n\nerror ",
		"tl_xe2": "404: Folder tidak ditemukan",
		"fl_xe1": "tidak dapat membuat daftar file dalam folder:\n\nerror ",
		"fl_xe2": "404: Folder tidak ditemukan",
		"fd_xe1": "could not create subfolder:\n\nerror ",
		"fd_xe2": "404: folder atas tidak ditemukan",
		"fsm_xe1": "tidak dapat mengirim pesan:\n\nerror ",
		"fsm_xe2": "404: folder atas tidak ditemukan",
		"fu_xe1": "gagal memuat daftar unpost dari server:\n\nerror ",
		"fu_xe2": "404: File tidak ditemukan??",
		...
		"un_fclr": "bersihkan filter",
		"un_derr": 'unpost-delete failed:\n',
		"un_f5": 'ada yang rusak, silahkan direfresh atau tekan F5',
		"un_uf5": "maaf tetapi Anda haru merefresh halaman (misal tekan F5 atau CTRL-R) sebelum unggahan ini dapat dibatalkan",
		...
		"un_max": "menunjukan file 2000 pertama (gunakan filter)",
		...
		"un_no1": "eits! tiada unggahan yang cukup baru",
		"un_no2": "eits! tiada unggahan yang cukup baru cocok dengan filter itu",
		"un_next": "delete the next {0} files below",
		"un_abrt": "batalkan",
		"un_del": "hapus",
		"un_m3": "memuat unggahan terakhir Anda...",
		"un_busy": "menghapus {0} file...",
		"un_clip": "{0} tautan disalin ke clipboard",

		"u_https1": "Anda seharusnya",
		"u_https2": "ganti ke https",
		"u_https3": "untuk perfoma lebih baik",
		"u_ancient": 'browser Anda sangat jaman purba sekali -- mungkin Anda harus coba <a href="#" onclick="goto(\'bup\')">pakai bup saja</a>',
		...
		"u_gotpot": 'mengganti ke UI kentang untuk kecepatan unggah lebih baik,\n\nsilahkan untuk tidak setuju dan ganti balik!',
		...
		"u_uput": 'optimalkan demi kecepatan (lompati checksum)',
		"u_ewrite": 'Anda tidak memiliki akses write ke folder ini',
		"u_eread": 'Anda tidak memiliki akses read ke folder ini',
		"u_enoi": 'file-search (cari-file) tidak diaktifkan di config server',
		"u_enoow": "overwrite tidak berfungsi disini; butuh izin Delete",
		...
		"u_s404": "tidak ditemukan di server",
		"u_expl": "jelaskan",
		...
		"u_unp_ok": 'unpost diizinkan untuk {0}',
		"u_unp_ng": 'unpost TIDAK akan diizinkan',
		"ue_ro": 'akses Anda ke folder ini Read-Only (Baca-Saja)\n\n',
		"ue_nl": 'Anda saat ini tidak login',
		"ue_la": 'Anda saat ini login sebagai "{0}"',
		...
		"ue_ta": 'coba unggah lagi, harusnya udah bisa sekarang',
		...
		"lang_set": "refresh untuk membuat perubahan diterapkan?",
	},
};
